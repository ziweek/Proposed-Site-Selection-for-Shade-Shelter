...
참여 방법
수준별 맞춤형 / 프로젝트 중심형 교육 내용을 실제 상황에 적용 및 활용 & 홈페이지 좌측 상단 ‘포트폴리오’ 탭에 업로드

git, 주피터 노트북 등 다양한 형태로 업로드 가능(※ 업로드 방법 하단 이미지 참조)

Kaggle, AI Hub, 공공 데이터 포털, 서울 열린 데이터 광장, 영화 진흥 위원회, 한국 소비자원 참가격 등 다양한 데이터 활용 가능
